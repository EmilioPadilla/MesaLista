 ...
 */
export const useGiftsByWeddingList = (weddingListId, options) => {
    return useQuery({
 ...
 * @param options React Query options
 */
export const useGiftById = (giftId, options) => {
    return useQuery({
...
export const useUpdateGift = () => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: ({ id, data }) => giftService.updateGift(id, data),
        onSuccess: (_, variables) => {
 ...
 * @param options React Query options
 */
export const usePurchasedGifts = (coupleId, options) => {
    return useQuery({
 ...
 * @param options React Query options
 */
export const useUserPurchases = (userId, options) => {
    return useQuery({
...
export const usePurchaseGift = () => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: ({ giftId, message }) => giftService.purchaseGift(giftId, message),
        onSuccess: () => {
